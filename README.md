...
QA Engineer con una sólida comprensión de los principios y procesos de control de calidad en el desarrollo de software (casos de prueba, API, Postman, Jira) así como pruebas de aplicaciones móviles 📱 (Android Studio) y automatizadas (Pupeteer, Javascript y Cypress). Con un enfoque meticuloso  orientado a los detalles 🕵️ , me esfuerzo por garantizar la entrega de productos de alta calidad que cumplan con estándares exigentes.Habilidades de liderazgo y trabajo en equipo , con alta orientación al aprendizaje  , gran sentido de la responsabilidad con los compromisos laborales  y buenas relaciones personales, proactiva, con facilidad de adaptación a nuevos entornos, iniciativa para completar tareas :working: y brindar soluciones eficientemente.
